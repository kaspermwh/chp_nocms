...
<body>
   ...
   <!-- Cases.php -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><?php echo $cases[1][0]; ?>
                    <small><?php echo $cases[1][1]; ?></small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="../../<?php echo $cases[1][4]; ?>" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="../../<?php echo $cases[1][5]; ?>" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="../../<?php echo $cases[1][6]; ?>" alt="">
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <ul>
                    <li>Bygherre: TDC Pensionskasse</li>
                    <li>Arkitekt: CHP Consult</li>
                    <li>Konsulent(er): Peter Møller Hansen</li>
                </ul>
            </div>
